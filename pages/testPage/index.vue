<template>
	<view class="transfer-warehouse pd-12">
		<app-input :isTest='true' class="mb-16" ref="inputRef" title="中转车条码" placeholder="请输入中转车条码" suffixIcon="scan" />
		...
		<app-select :isTest='true' ref="platformRef" title="站台编码" placeholder="请选择站台编码" popupTitle="请选择站台编码"
...
<script setup>
	...
	const transferCarTree = uni.getStorageSync('STORAGE_sys_dict').transfer_car_type
